...
function monogram(workspace: WorkspaceSummary): string {
  ...
  return (workspace.name || workspace.slug).trim().charAt(0).toUpperCase() || "T";
}
    ...
    <div ref={ref} className="relative">
            ...
            {workspaces.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="min-w-0 flex-1 truncate">{teamLabel(item)}</span>
      ...
      >
        ...
        <span className="min-w-0 flex-1">
          <span className="block truncate text-sm font-medium text-foreground/90">{teamLabel(workspace)}</span>
