...
Artifacts reads environment from the monorepo `.env` file during local development. Production deployments should provide the same variables through the platform secret store.
