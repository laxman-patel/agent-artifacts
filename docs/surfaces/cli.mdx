...
Upload the files from `apps/cli/dist/release/v<version>/` to the matching GitHub Release tag. The public web app on Railway exposes `hostartifacts.dev/install.sh` as the memorable installer URL, redirecting to the latest release installer.
