import type { AgentScope, ArtifactAction, ArtifactRole, Principal } from "@agent-artifacts/shared";
...
const actionMinimumRole: Record<ArtifactAction, ArtifactRole> = {
  ...
  "artifact.fork": "viewer",
  "artifact.diff": "viewer",
  "artifact.archive": "admin",
...
const actionScope: Partial<Record<ArtifactAction, AgentScope>> = {
  ...
  "artifact.fork": "artifacts:create",
  "artifact.diff": "artifacts:read",
  "artifact.archive": "artifacts:delete",
...
export function hasRole(role: ArtifactRole | undefined, required: ArtifactRole): boolean {
  return role !== undefined && roleRank[role]! >= roleRank[required]!;
}

export function hasScope(principal: Principal, requiredScope: AgentScope | undefined): boolean {
...
export function canPerformArtifactAction(input: ArtifactPolicyInput): PolicyDecision {
